function readForm()
		{
		var FirstName, LastName, city, numberofguest, daystaying, Choiceofmeal, Extracomments, Totalcostforthetrip;
		var d = new Date();
		...
		Totalcostforthetrip= ((city*numberofguest)+(choicecost*daystaying)+(Choiceofmeal*numberofguest)+(wifiandseat*numberofguest));
		
		
		document.write("Dear " + FirstName + " " + LastName + ", Congraulations you have successfully booked your trip! Your trip going to cost you $" + Totalcostforthetrip + ". And you have sepical requested: " 
		+ Extracomments + " Good bye! Have a safe trip. Thank you for visiting Patel's Travels and we look forward hearing back from you about your experience booking through Patel's Travels.");
		}